...
모델 파일 링크: category, sentimental
실행시 의도된 디렉토리 구조

### web_demo_for_colab.ipynb

LLM 리포트 생성웹 데모
defalut llama3.1-8b 사용 시 hugging face 승인 및 토큰 필요(다른 모델 사용 가능, 파일 내 참조)
YouTube API key 필요(get from https://console.developers.google.com)
